...
import (
	sap_api_caller "sap-api-integrations-process-order-creates/SAP_API_Caller"
	sap_api_input_reader "sap-api-integrations-process-order-creates/SAP_API_Input_Reader"
	"sap-api-integrations-process-order-creates/config"
...
func main() {
	...
	inputSDC := fr.ReadSDC("./Inputs/SDC_Process_Order_General_sample.json")
